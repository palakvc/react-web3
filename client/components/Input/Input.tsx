...
const inputStyles: string = `border border-gray-300 dark:border-gray-700 pr-10 dark:bg-darkPrimary placeholder-gray-500 rounded-32 text-gray-600 focus:z-10 p-2 outline-none focus:ring`;
